...
const initialItems: TwitterItem[] = [
  {
    ...
    date: '12 Aug 2025',
    preview: 'Learn how our AI tool now integrates seamlessly with X for realâ€‘time posting.',
    status: 'Ready',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    date: '05 Jul 2025',
    preview: 'Stepâ€‘byâ€‘step guide to pinning tweets and driving traffic to your profile.',
    status: 'Published',
  },
  {
    id: 4,
