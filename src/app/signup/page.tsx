...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-transparent dark:bg-[#000] px-4 pt-8">
      ...
      <div className="mb-8">
        <Image
          src="https://omnipressence.com/wp-content/uploads/2025/07/current-crop-1-1.webp"
      ...
      <form onSubmit={handleSignUp} className="w-[350px] mx-auto">
        ...
        <div className="mb-[16px]">
          ...
          <input
            ...
            required
            className="w-full px-4 py-[10px] text-xl border border-[#d1d5db] rounded-[10px] bg-[#fff] dark:bg-[#111] text-[#000] placeholder:text-[#888] focus:outline-none"
          />
        </div>
        ...
        <button
          type="submit"
          className="w-full px-4 py-[10px] text-xl font-semibold text-white bg-[#FF6600] rounded-[10px] hover:bg-[#e65500] transition mb-[16px]"
        >
          Sign Up
        </button>
      </form>
