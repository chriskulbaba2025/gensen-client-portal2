...
export default function GenerateStep1() {
  ...
  return (
    <div className="min-h-screen px-[40px] py-[60px] text-black dark:text-white">
...
/>
        ...
        <div className="text-center">
          <button
            className="mt-[20px] bg-white text-black hover:bg-[#f66630] hover:text-white px-[20px] py-[10px] rounded-[10px] hover:scale-105 transition"
            onClick={() => {
              console.log({ keywords, audience, length });
              // navigation or validation can go here
            }}
          >
            Next Step
          </button>
